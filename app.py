...
<div class="main-header">
    ...
    <p>OPOPng giáo: Hoàng Anh Tuấn - Trường Tiểu học Nà Chì - ĐT: 0839637157</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Anh Tuấn - Trường Tiểu học Nà Chì - ĐT: 0839637157</div>", unsafe_allow_html=True)
